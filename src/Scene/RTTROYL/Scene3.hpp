#ifndef SCENE__RTTROYL__SCENE3_HPP
#define SCENE__RTTROYL__SCENE3_HPP
...
public:
    ...
    void init_world() override {
        ...
        std::shared_ptr<Geometry> ball = std::make_shared<Sphere>(vec4(190.0f, 90.0f, 190.0f), 90, glass);
