#ifndef SCENE__RTTROYL__SCENE2_HPP
#define SCENE__RTTROYL__SCENE2_HPP
...
public:
    ...
    void init_world() override {
        ...
        std::shared_ptr<Material> aluminium = std::make_shared<Metal>(vec4(0.8f, 0.85f, 0.88f));
        std::shared_ptr<Geometry> box1 = Box(vec4(0.0f, 0.0f, 0.0f), vec4(165.0f, 330.0f, 165.0f), aluminium);
